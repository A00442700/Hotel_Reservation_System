...
//        recyclerView.setAdapter(hotelListAdapter);
    ...
    public void onClick(View view, int position) {
        ...
        String check_in_date = getArguments().getString("check in date");
        String check_out_date = getArguments().getString("check out date");

        Bundle bundle = new Bundle();
        bundle.putString("hotel name", hotelName);
        bundle.putString("hotel price", price);
        bundle.putString("hotel availability", availability);
        bundle.putString("check in date", check_in_date);
        bundle.putString("check out date", check_out_date);

        //bundle.get("check in date");
